...
def setup():
    ...
    return PyChain([Block(record=('Genesis', 'Genesis', 0), creator_id = 0)])
...
# YOUR CODE HERE
sender = st.text_input("Ender Sender Account")
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver = st.text_input("Recipient Account")
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amount = st.text_input("Amount Sending")

rec = Record(sender=sender, receiver=receiver, amount=amount)
